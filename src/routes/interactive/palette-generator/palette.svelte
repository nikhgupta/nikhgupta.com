<script lang="ts">
	...
	import { zoomedPalette, showColor } from './store';
...
<div class="color-palette {$zoomedPalette && $zoomedPalette != name ? 'hidden' : ''}">
	...
	<div class={classNameZoomed}>
		{#each colors as c}
			<div
				class="w-full {zoomed ? 'h-full' : 'h-16'} flex items-center justify-center"
